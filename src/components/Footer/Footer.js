                ...
                <footer className="row flex-wrap-reverse pt-5 my-5">
                    ...
                    <div className="d-flex flex-wrap justify-content-between col-12 col-md-6 col-gl-6">
                        ...
                        <div className="col-12 col-md-2 col-gl-2 mb-3">
                            <h5>CONTACT</h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">(+92) 308-8571276</a></li>
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">zohaibsaleem0202@gmail.com</a></li>
